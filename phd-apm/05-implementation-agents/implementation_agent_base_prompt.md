...
description: Base template for all Implementation Agents in phd-apm, combining upstream APM v0.5 patterns with manuscript review specialization
agent_id: BASE
...
**Version**: PhD-APM v1.0 (Upstream APM v0.5 Compatible)

This document serves as the foundational template for all 26 Implementation Agents in the phd-apm system. It combines upstream APM v0.5 patterns with manuscript review domain specialization.
