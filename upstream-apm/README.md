...
1.  **👤 Use the APM Template (Recommended for Custom Projects):**
    ...
    - **Ideal Setup:** Clone _your new repository_, ideally at the root of your project workspace.
...
| 🔁       | **[Context & Memory Management](docs/Context_and_Memory_Management.md)** _(Advanced)_   | How APM handles agent context and preserves key information.                            |
| 👤 / 🤖  | **[Context & Prompt Engineering](docs/Context_and_Prompt_Engineering.md)** _(Advanced)_ | Prompt and Context Engineering techniques, including drag-and-drop agent snippets.      |
