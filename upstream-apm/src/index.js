...
`)
  .action(async (options) => {
    try {
      ...
      console.log(chalk.white('   1. Review generated files in ') + chalk.cyan('.apm/'));
      console.log(chalk.white('   2. Customize prompts for your project'));
      console.log(chalk.white('   3. Start using APM with ') + chalk.cyan(assistantsToInstall.join(', ')));
      console.log(chalk.white('   4. Run ') + chalk.yellow('apm update') + chalk.white(' for latest improvements\n'));
